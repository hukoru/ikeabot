...
# Scrapy settings for crow project
#
...
SPIDER_MODULES = ['crow.spiders']
NEWSPIDER_MODULE = 'crow.spiders'
...
#    'proxy.randomproxy.RandomProxy': 100,
...
DOWNLOADER_MIDDLEWARES = {
    'crow.middleware.RandomUserAgent': 1,
    'crow.middleware.ErrorMonkeyMiddleware': 2,
}
